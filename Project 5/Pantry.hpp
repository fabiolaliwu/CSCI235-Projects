/*
CSCI235 Spring 2024
Project 5 - Pantry Class
Fabiola Li Wu
Feb 22nd 2024
Pantry.hpp declares the Pantry class along with its private and public members and struct Ingredient
*/
#ifndef PANTRY_
#define PANTRY_
...
*/
    Ingredient() : name_{""}, description_{""}, quantity_{0}, price_{1}, recipe_{}
    {
    }
    ...
    /**
      ...
      */
    Ingredient(const std::string &name, const std::string &description, int quantity, int price, std::vector<Ingredient *> recipe) : name_{name},
                                                                                                                                     description_{description}, quantity_{quantity}, price_{price}, recipe_{recipe}
    {
    }
};
...
*/
    ...
    */
    bool addIngredient(const std::string &name, const std::string &description, const int &quantity,
    ...
    */
    void printIngredient(Ingredient *) const;
    ...
    */
    void ingredientQuery(const std::string &) const;
    void recursivelyPrint(Ingredient *ingredient) const;
